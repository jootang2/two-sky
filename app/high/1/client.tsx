...
const REGULAR_SUBJECTS = [
  {
    label: "다항식·방정식",
    lines: [
      "고차방정식, 나머지 정리, 인수분해 심화",
      "복소수 개념과 이차방정식의 판별식 활용",
    ],
  },
  {
    label: "도형의 방정식",
    lines: [
      "직선·원의 방정식, 도형의 이동과 대칭",
      "좌표기하를 통한 도형 문제 풀이 능력 완성",
    ],
  },
  {
    label: "수열·지수·로그",
    lines: [
      "등차·등비수열, 지수법칙과 로그의 성질",
      "지수·로그함수 그래프와 방정식·부등식 응용",
    ],
  },
  {
    label: "통합과학",
    lines: [
      "물질과 규칙성, 시스템과 상호작용, 변화와 다양성",
      "수능 과학탐구 연계를 고려한 핵심 개념 정리",
    ],
  },
];
...
const ASSESSMENTS = [
  ...
  {
    title: "모의고사 대비",
    desc: "고1부터 수능 체제에 익숙해질 수 있도록 실전 모의고사 풀이와 분석을 병행합니다. 교육청 모의고사 기출을 활용한 실전 감각 훈련을 통해 수능 수학·과학탐구 준비를 조기에 시작합니다.",
    date: "연 4회 (3월 / 6월 / 9월 / 11월)",
    details: [
      "교육청 모의고사 기출 문제 집중 분석",
...
export default function High1Client() {
    ...
    <div className="min-h-screen bg-white">
      <section className="relative h-36 bg-gray-700 flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          <h1 className="text-3xl font-bold text-white mb-1">고 1</h1>
