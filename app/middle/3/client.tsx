...
const REGULAR_SUBJECTS = [
  {
    label: "실수·제곱근",
    lines: [
      "무리수와 실수 체계 이해, 근호를 포함한 식의 계산",
      "제곱근의 성질을 활용한 연산 능력 완성",
    ],
  },
  {
    label: "인수분해·이차방정식",
    lines: [
      "다항식의 인수분해와 이차방정식 풀이",
      "판별식을 활용한 근의 분류와 활용 문제 해결",
    ],
  },
  {
    label: "이차함수",
    lines: [
      "이차함수 그래프의 특징과 최댓값·최솟값",
      "이차함수와 이차방정식의 관계를 통한 심화 이해",
    ],
  },
  {
    label: "과학",
    lines: [
      "화학반응의 규칙, 자극과 반응, 유전과 진화",
      "중학 과학 핵심 내용 총정리 및 고등 과학 연계",
    ],
  },
];
...
export default function Middle3Client() {
    ...
    <div className="min-h-screen bg-white">
      <section className="relative h-36 bg-gray-700 flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          <h1 className="text-3xl font-bold text-white mb-1">중 3</h1>
