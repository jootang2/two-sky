...
const REGULAR_SUBJECTS = [
  {
    label: "수와 연산",
    lines: [
      "소인수분해, 정수와 유리수의 사칙연산 개념 완성",
      "수의 체계를 이해하고 계산 원리를 정확히 익히기",
    ],
  },
  {
    label: "문자와 식",
    lines: [
      "문자를 사용한 식의 표현과 일차방정식 풀이",
      "방정식을 활용한 실생활 문제 해결 능력 향상",
    ],
  },
  {
    label: "함수·그래프",
    lines: [
      "좌표평면 이해, 정비례·반비례 관계 완성",
      "그래프 해석 능력과 함수 개념의 기초 다지기",
    ],
  },
  {
    label: "과학",
    lines: [
      "힘과 운동, 물질의 분류와 변화, 지구와 달의 운동",
      "과학적 탐구 방법과 핵심 개념 정리",
    ],
  },
];
...
export default function Middle1Client() {
    ...
    <div className="min-h-screen bg-white">
      <section className="relative h-36 bg-gray-700 flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          <h1 className="text-3xl font-bold text-white mb-1">중 1</h1>
